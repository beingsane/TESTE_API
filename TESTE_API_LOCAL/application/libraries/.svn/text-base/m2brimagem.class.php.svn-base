...
//------------------------------------------------------------------------------
// manipulaçãoo da imagem	

	/**
	 * Cria objeto de imagem para manipulaçãoo no GD
	 * @param
	 * @return void
	*/	
...
// funÃ§Ãµes para redimensionamento
	...
	*/	
	public function redimensiona( $nova_largura = 0, $nova_altura = 0, $tipo = '' ) 
	{
		...
		// seta variáveis passadas via parÃ¢metro
	...
	*/	
	...
	/**
	 * Adiciona cor de fundo á  imagem
	 * @param
	 * @return void
	*/
	...
	*/	
	private function resizeFill() 
	{
		...
		// adiciona cor de fundo a  nova imagem
		$this->preencheImagem();
		
		// salva variáveis para centralizaçãoo
	...
	/**
	 * Calcula a posiçãoo do crop
	 * Os Ã­ndices 0 e 1 correspondem Ã  posiçãoo x e y do crop na imagem
...
//------------------------------------------------------------------------------
// funÃ§Ãµes de manipulaçãoo da imagem
	...
	*/	
	 ...
	 * @param Int $x posiçãoo x do texto na imagem
	 * @param Int $y posiçãoo y do texto na imagem
	...
	*/	
	 ...
	 * @param Int $x posiçãoo x da marca na imagem
	 * @param Int $y posiçãoo y da marca na imagem
	 * @return Boolean true/false dependendo do resultado da operaçãoo 
	 * @param Int $alfa valor para transparÃªncia (0-100)
	 			  -> se utilizar alfa, a funçãoo imagecopymerge não preserva
	 ...
	 * Implementaçãoo original por Giolvani <inavloig@gmail.com>
	 * @param String $imagem caminho da imagem de marca d'água
	 * @param String $posicao posiçãoo/orientaçãoo fixa da marca d'água
	...
	*/	
	public function grava( $destino='', $qualidade = 100 ) 
	{
		...
		{	
			...
			{
				$this->erro	= 'DiretÃ³rio de destino inválido ou inexistente';
				return false;
			}
